...
const KNOWN_WITH_PATH = {
  ...
  'app.bsky.feed.post|.facets[app.bsky.richtext.facet].features[app.bsky.richtext.facet#link].uri':
    {
      type: 'bsky-link',
      label: 'Linked on Bluesky',
      icon: 'link',
  ...
  'app.bsky.feed.post|.bridgyOriginalUrl': {
    type: 'bsky-link',
    label: 'Linked on Bluesky',
    icon: 'link',
    app: 'Bluesky',
